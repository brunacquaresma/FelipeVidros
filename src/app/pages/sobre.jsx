...
import Loja from '/public/loja.webp'
    ...
    return (
        ...
        flex flex-col sm:flex-row justify-center py-2 pt-7 sm:pt-0 items-center h-full border-t`}>
            ...
            px-10 pb-9 w-screen sm:w-1/2 text-center sm:text-start`}>
                ...
                <p className="text-lg leading-loose">Há 14 anos no mercado, a <span className="font-bold">
                    Felipe Vidros e Esquadrias</span> trabalha com obras de pequeno e grande porte, com alto padrão de qualidade e segurança. {emoji} </p>
            </div>
        </section>
    )
}
